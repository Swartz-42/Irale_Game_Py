...
class MainMenu:
    ...
    def disp(self):
        play_btn = PlayButton(self.game.screen, (self.x / 2 - 370 / 2, 200, 370, 109), self.game.run)
        setting_btn = SettingButton(self.game.screen, (self.x / 2 - 370 / 2, 350, 370, 109), None)
        quit_btn = QuitButton(self.game.screen, (self.x / 2 - 370 / 2, 500, 370, 109), freeExit)
        self.list_bnt = [play_btn, setting_btn, quit_btn]
